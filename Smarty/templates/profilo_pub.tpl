      ...
      <div class="row profile">
		...
		<div class="col-md-9">
            <div class="profile-content">
              <h4 class="text-center">Vinili in vendita:</h4>

         	<div class="col-md-18">
     			<div class="col-sm-6 col-md-4">
     				<div class="thumbnail" >
     					<h4 class="text-center"><span class="label label-info">Titolo Vinile</span></h4>
     					<img src="../../Utility/immagini/vinile0.jpg" class="img-responsive">
     					<div class="caption">
     						<div class="row">
     						...
     						<div class="row">
     							...
     							<div class="col-md-6">
     								<a href="#" class="btn btn-success btn-product"><span class="glyphicon glyphicon-shopping-cart"></span>Contatta il venditore</a></div>
     						</div>
                <p><hr></p>
     					</div>
     				</div>
          ...
          <div class="col-sm-6 col-md-4">
     				<div class="thumbnail" >
     					<h4 class="text-center"><span class="label label-info">Titolo Vinile</span></h4>
     					<img src="../../Utility/immagini/vinile1.jpg" class="img-responsive">
     					<div class="caption">
     						<div class="row">
          ...
          <div class="col-sm-6 col-md-4">
     				<div class="thumbnail" >
     					<h4 class="text-center"><span class="label label-info">Titolo Vinile</span></h4>
     					<img src="../../Utility/immagini/vinile2.jpg" class="img-responsive">
     					<div class="caption">
     						<div class="row">
     							<div class="col-md-6 col-xs-6">
     								<h3>Artista</h3>
